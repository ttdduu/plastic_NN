...
class AnalyzeEccSf:
    ...
    def __init__(
        ...
        *,
        ...
        output_nickname = "cnn_copy_of_bbsedv"
        self.root = f"/home/tomasdu/repos/datasets/{rootname}/"
        self.cnn_model_root = "CNN_model" # useless
        self.rsl_model_root = "RSL_model" # useless
        ...
        # "/home/tomasdu/repos/datasets/daCosta2024-remake/stimuli/sinrings/"
    ...
    def load_model(self, model):
        """
                ...
                """
        if model == "cnn":
            self.stim_folder = self.cnn_stim_folder # useful if the sinrings are w/o transform
            self.model_folder = self.cnn_model_root # useless
        ...
        # from src.models.cornet_dwsep import CustomCornetZDWSep as Model
        from src.models.cornet_dwsep import CustomCornetDWSep as Model
        # from src.models.cornet_dwsep_lc import CustomCornetDWSepLC as Model
        # from src.models.cornet_z_daCosta import CustomCornetZDaCosta as Model
