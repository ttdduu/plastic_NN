...
from src.models.utils.conv_to_lc import _pool2d_output_size, _tile_tensor_to_lc, _copy_matching_keys


# tile tesnor to lc, pool2d output size and copy matching keys were defined here
...
class CustomCornetDWSepLC(BaseModel):
    ...
    def __init__(
        ...
        self.depths = [1,1,3,1]
        self.dims = [int(i*j) for i in [init_size,init_size*4,init_size*8,init_size*12]]
